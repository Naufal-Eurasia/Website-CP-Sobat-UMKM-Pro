      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-20">
          <div className="relative group overflow-hidden rounded-3xl shadow-xl h-[450px] md:h-[500px]">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0a1628] via-[#0a1628]/80 to-transparent flex items-end p-6 md:p-12">
              <p className="text-white text-sm md:text-2xl italic max-w-3xl leading-snug md:leading-relaxed">
